  ...
  return (
    <div>
      <button className="relative inline-flex h-12 w-full overflow-hidden rounded-lg p-[1px] focus:outline-none md:w-60 md:mt-10">
        ...
        <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-lg bg-black-100 hover:bg-transparent bg-opacity-95 px-7 text-sm font-medium text-white backdrop-blur-3xl gap-2">
          {position === "keft" && icon}
          {title}
          {position === "right" && icon}
        </span>
